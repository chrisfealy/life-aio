import { BarChart3, Dumbbell, NotebookPen, Wallet, type LucideIcon } from 'lucide-react'
            ...
            {links.map((link) => (
              <NavLink
                ...
                className={`flex items-center gap-1.5 rounded-md px-3 py-1.5 text-sm font-medium ${
                  link.match(pathname) ? 'bg-blue-600 text-white' : 'text-slate-600 hover:bg-slate-100'
                }`}
              >
