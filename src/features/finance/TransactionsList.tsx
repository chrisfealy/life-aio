...
function EditRow({
  ...
  saving: boolean
  onCancel: () => void
  onSave: (input: { txnDate: string; amount: number; direction: TransactionDirection; categoryId: string | null; note: string | null }) => void
}) {
  ...
  function handleSave() {
    ...
    onSave({ txnDate: date, amount: value, direction, categoryId: categoryId || null, note: note.trim() || null })
  }
